...
resource "aws_lambda_function" "func" {
  ...
  image_uri     = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${data.aws_region.current.name}.amazonaws.com/${data.external.envs.results.project_name}:${data.external.envs.result.sha}"
